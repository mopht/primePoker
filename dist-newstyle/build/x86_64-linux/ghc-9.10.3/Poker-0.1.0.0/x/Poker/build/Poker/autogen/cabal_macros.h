...
/* package Poker-0.1.0.0 */
#ifndef VERSION_Poker
#define VERSION_Poker "0.1.0.0"
#endif /* VERSION_Poker */
#ifndef MIN_VERSION_Poker
#define MIN_VERSION_Poker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Poker */
...
#define CURRENT_COMPONENT_ID "Poker-0.1.0.0-inplace-Poker"
